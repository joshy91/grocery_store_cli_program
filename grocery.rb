...
def change_quantity(product)
	puts "you want to change the quantity of " + product.name
...
products.push(puffs, lucky_charms, pops, muesli, captain_crunch, chocolate_chip, oatmeal, chocolate_chocolate_chip, sugar, gingersnap)
